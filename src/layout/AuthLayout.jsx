...
const AuthLayout = () => {
  return (
    <div className="w-full min-h-[100vh] bg-gradient-to-b from-opacity-60 via-black via-opacity-60 to-transparent flex items-center justify-center flex-col gap-[20px] p-[10px] "
    style={{
